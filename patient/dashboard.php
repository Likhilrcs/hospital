...
$sql = "SELECT COUNT(*) as count FROM appointments WHERE patient_id = ? AND status = 'completed'";
if ($stmt = mysqli_prepare($conn, $sql)) {
    mysqli_stmt_bind_param($stmt, "i", $patient_id);
    if (mysqli_stmt_execute($stmt)) {
        $result = mysqli_stmt_get_result($stmt);
...
// Count prescriptions
$sql = "SELECT COUNT(*) as count FROM prescriptions WHERE patient_id = ?";
if ($stmt = mysqli_prepare($conn, $sql)) {
    mysqli_stmt_bind_param($stmt, "i", $patient_id);
    if (mysqli_stmt_execute($stmt)) {
        $result = mysqli_stmt_get_result($stmt);
        if ($row = mysqli_fetch_assoc($result)) {
            $stats['prescriptions'] = $row['count'];
        }
    }
    mysqli_stmt_close($stmt);
}
...
$sql = "SELECT a.*, d.first_name as doctor_first_name, d.last_name as doctor_last_name, d.specialization
        FROM appointments a 
...
<head>
    ...
    <meta name="description" content="Patient dashboard for MediCare Pro Hospital Management System">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="user-info">
                    ...
                    <span class="d-none d-md-inline"><?php echo htmlspecialchars($patient_info['first_name'] . ' ' . $patient_info['last_name']); ?></span>
        ...
        <div class="container">
            <div class="dashboard-container" data-aos="fade-up">
                <div class="dashboard-header">
                    ...
                    <p class="dashboard-subtitle">Welcome back! Manage your health appointments and records</p>
                </div>

                <!-- Patient Info -->
                <div class="patient-info-card" data-aos="fade-up" data-aos-delay="100">
                    <div class="patient-info-header">
                        <div class="patient-avatar">
                            <i class="fas fa-user"></i>
                        </div>
                        <div class="patient-details">
                            <h3><?php echo htmlspecialchars($patient_info['first_name'] . ' ' . $patient_info['last_name']); ?></h3>
                            <p><i class="fas fa-envelope"></i> <?php echo htmlspecialchars($patient_info['email']); ?></p>
                            <p><i class="fas fa-phone"></i> <?php echo htmlspecialchars($patient_info['phone']); ?></p>
                            <p><i class="fas fa-calendar"></i> Date of Birth: <?php echo date('F j, Y', strtotime($patient_info['date_of_birth'])); ?></p>
                            <span class="badge">Patient ID: <?php echo $patient_info['id']; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="stat-number" data-count="<?php echo $stats['upcoming']; ?>">0</div>
                    ...
                    <div class="stat-card" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="stat-number" data-count="<?php echo $stats['prescriptions']; ?>">0</div>
                ...
                <div class="quick-actions" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div class="actions-grid">
                        ...
                        <a href="view_prescriptions.php" class="action-btn">
                            <i class="fas fa-prescription"></i>
                            View Prescriptions
                        </a>
                ...
                <!-- Upcoming Appointments -->
                <div class="upcoming-appointments" data-aos="fade-up" data-aos-delay="700">
                    <h3 class="section-title">
                    ...
                    <?php if (empty($upcoming_appointments)): ?>
                        <div class="text-center py-4">
                            ...
                            <p class="mt-3 text-muted">No upcoming appointments scheduled</p>
                        ...
                        <?php foreach ($upcoming_appointments as $appointment): ?>
                            <div class="appointment-card">
                                ...
                                <div class="appointment-actions">
                                    <a href="#" class="btn-small btn-primary-small">
                                        <i class="fas fa-eye"></i> View Details
                                    </a>
                                    <?php if ($appointment['status'] === 'pending'): ?>
                                        <a href="#" class="btn-small btn-success-small">
